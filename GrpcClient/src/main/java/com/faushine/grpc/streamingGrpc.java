...
public final class streamingGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Streaming.Message,
      Streaming.APIResponse> getHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<Streaming.Message,
      Streaming.APIResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<Streaming.Message, Streaming.APIResponse> getHelloMethod;
  ...
  public static abstract class streamingImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<Streaming.Message> hello(
        io.grpc.stub.StreamObserver<Streaming.APIResponse> responseObserver) {
